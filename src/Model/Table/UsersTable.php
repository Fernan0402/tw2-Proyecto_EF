...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('password', __('La contraseña es obligatoria'), 'create')
            ->allowEmptyString('password', __('Dejar vacío para no cambiar'), 'update');
        ...
        $validator
            ...
            ->add('language', 'languageList', [
                'rule' => fn ($value) => $value === null || $value === '' || in_array($value, ['es', 'en'], true),
